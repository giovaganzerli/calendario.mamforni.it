          ...
          <div class="vue-lightbox-figure">
            <swiper class="vue-lightbox-figure" :options="swiperOptionTop" ref="swiperTop">
              <swiper-slide v-for="(image, index) in images" :key="index">
                <img class="vue-lightbox-modal-image" :src="getImageType(image)" srcset="" @click="openFile(image)">
        ...
        <div class="vue-lightbox-thumbnail-wrapper" v-show="images.length > 1 && showThumbs">
          <div class="vue-lightbox-thumbnail">
            ...
            <swiper :options="swiperOptionThumbs" ref="swiperThumbs">
              <swiper-slide v-for="(image, index) in images" :key="index">
                <div class="vue-lightbox-modal-thumbnail vue-lightbox-modal-thumbnail-active" :data-src="getImageType(image)" v-lazy:background-image="getImageType(image)" :style="`background-image: url(&quot;${getImageType(image)}&quot;);`"></div>
              </swiper-slide>
            </swiper>
...
export default {
  ...
  methods: {
    ...
    getImageType: function (image) {
      var ext = image.name.split('.').pop().toLowerCase(), path = image.path;
      switch (ext) {
        case 'pdf':
